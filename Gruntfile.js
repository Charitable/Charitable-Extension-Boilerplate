        ...
        rename: {
            ...
            gateway: {
                files : [
                    ...
                    {
                        src: ['build/' + _textdomain + '/includes/gateway/class-charitable-extension-boilerplate-webhook-processor.php' ],
                        dest: ['build/' + _textdomain + '/includes/gateway/class-charitable-' + _gateway_id + '-webhook-processor.php' ],
                    },
                    {
